...
export default function Offices() {
  return (
    ...
    <a className="flex items-center justify-center px-2 text-indigo-500 transition hover:text-indigo-400" href="/offices">
      ...
      <h2 className="text-white text-xs">India</h2>
    </a>
    <a className="flex items-center justify-center px-2 text-indigo-500 transition hover:text-indigo-400" href="/offices">
      <svg
        className="h-4 w-4 fill-current"
      ...
      <h2 className="text-white text-xs">USA</h2>
    </a>
    <a className="flex items-center justify-center px-2 text-indigo-500 transition hover:text-indigo-400" href="/offices">
      <svg
        className="h-4 w-4 fill-current"
      ...
      <h2 className="text-white text-xs">UK</h2>
    </a>
    <a className="flex items-center justify-center px-2 text-indigo-500 transition hover:text-indigo-400" href="/offices">
      <svg
        className="h-4 w-4 fill-current"
      ...
      <h2 className="text-white text-xs">France</h2>
    </a>
    </div>
    </div>
  );
