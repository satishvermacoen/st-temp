...
export default function Offices() {
  return (
    <div className="z-10 mt-2 w-full md:mt-5 px-10 flex-row">
    <div className="flex flex-row justify-between">
    <h2 className="text-white flex-row pt-2">Our Offices:</h2>          
    <a className="flex items-center justify-center px-2 text-indigo-500 transition hover:text-indigo-400" href="">
      <svg
      ...
      <h2 className="text-white text-xs">29A Regvendra nager, Gwalior</h2>
    </a>
    <a className="flex items-center justify-center px-2 text-indigo-500 transition hover:text-indigo-400" href="">
      <svg
        className="h-4 w-4 fill-current"
